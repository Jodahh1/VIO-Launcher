...
watch(
  () => themeStore.collapsedNavigation,
  (collapsedNavigation) => {
    sidebarOpen.value = !collapsedNavigation
  },
  { immediate: true },
)
  ...
  <div v-if="failureText" class="failure dark-mode">
    ...
    <div class="error-view dark-mode">
      <Card class="error-text">
        ...
        <div class="error-div">
          VIO Launcher failed to load correctly. This may be because of a corrupted file, or because
